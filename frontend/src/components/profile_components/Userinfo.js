...
function Userinfo(props) {
  props=props.data.User[0]
  // Initialize state with values from props or default to empty strings
...
<div className="relative z-0 w-full mb-5 group">
  ...
  >
    Phone Number
        ...
        {/* Add similar input fields for other form data (country, pin, dob, phone) */}
